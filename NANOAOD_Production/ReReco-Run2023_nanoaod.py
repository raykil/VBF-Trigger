...
# with command line options: RECO --conditions 130X_dataRun3_Prompt_v3 --customise Configuration/DataProcessing/Utils.addMonitoring,PhysicsTools/NanoAOD/nano_cff.nanoL1TrigObjCustomize --datatier NANOAOD --era Run3 --eventcontent NANOAOD --filein input.root --fileout output.root --no_exec --python_filename ReReco-Run2023_nanoaod.py --scenario pp --step NANO --data

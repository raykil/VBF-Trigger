...
triggerObjectTable = triggerObjectTableProducer.clone(
    ...
    selections = cms.VPSet(
        ...
        cms.PSet(
            ...
            skipObjectsNotPassingQualityBits = cms.bool(True),
            qualityBits = cms.VPSet(
                mksel(["hltL1PFJetCategoriesVBFinclLoose"]),
                mksel(["hltL1PFJetCategoriesVBFinclLooseTripleJet"]),
                ...
                mksel(["hlt3PFCentralJetTightIDPt40"]), # old 128, new 512
                ...
                mksel(["hltPFDoubleJetTightID40"]),
                mksel(["hltPFSingleJetTightID105"]),
            )
        ),
        cms.PSet(

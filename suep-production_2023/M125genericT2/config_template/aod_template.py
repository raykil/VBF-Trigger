...
# with command line options: step2 --python_filename aod_template.py --eventcontent AODSIM --datatier AODSIM --filein {[FILEIN]} --fileout {[FILEOUT]} --conditions 130X_mcRun3_2023_realistic_v14 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 1 --geometry DB:Extended --era Run3_2023 --no_exec --mc -n -13596
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:-13596'),

...
# with command line options: step1 --python_filename miniaod_template.py --eventcontent MINIAODSIM --datatier MINIAODSIM --filein {[FILEIN]} --fileout {[FILEOUT]} --conditions 130X_mcRun3_2023_realistic_v14 --step PAT --nThreads 1 --geometry DB:Extended --era Run3_2023 --no_exec --mc -n -13596
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:-13596'),

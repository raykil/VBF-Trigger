...
# with command line options: PhysicsTools/SUEPNano/python/fragments/VBF_final.py --python_filename gensim_template.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout {[FILEOUT]} --conditions 130X_mcRun3_2023_realistic_v14 --beamspot Realistic25ns13p6TeVEarly2023Collision --step GEN,SIM --geometry DB:Extended --era Run3_2023 --no_exec --mc -n -13596
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(-13596),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('PhysicsTools/SUEPNano/python/fragments/VBF_final.py nevts:-13596'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '25:m0 =  125',
            '999999:all = GeneralResonance void 0 0 0 2 0.001 0.0 0.0 0.0',
            '999998:all = GeneralResonance void 1 0 0 1 0.001 0.0 0.0 0.0',
            '999999:addChannel = 1 1.0 101 999998 999998 ',
            '999998:addChannel = 1 1 101 211 -211'
        ),

...
# with command line options: --python_filename nano.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:options.outputFile --conditions 126X_mcRun3_2022_realistic_postEE_v1 --step NANO --scenario pp --filein file:options.inputFiles --era Run3,run3_nanoAOD_124 --no_exec --mc -n -1
